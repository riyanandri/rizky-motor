    ...
    <div class="breadcrumb-area">
        <div class="container">
            <div class="breadcrumb-content">
                <h2>Produk Berdasarkan Merek</h2>
                <ul>
                    <li class="active">semua produk dengan merek "<b>{{ $merk->name }}</b>"</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="shop-toolbar">
                        ...
                        <div class="product-item-selection_area">
                            <div class="product-short">
                                <label class="select-label">Ditemukan {{ $products->count() }} produk dengan merek {{ $merk->name }}</label>
                            </div>
                        </div>
                    </div>
